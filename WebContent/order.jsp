	...
	<% 
		...
		try ( Connection con = DriverManager.getConnection(url, uid, pw);
			...
			if( productList.size() != 0 && idValid && passValid){//Then the inputs are valid, we will start saving order information to database
				...
				out.println("<h2><a href=\"editaddress.jsp\" class=\"a\">Click me to change your shipping address</a></h2>");
				...
				out.println("<h2><a href=\"payment.jsp\" class=\"a\">Click me to finish your payment</a></h2>");
