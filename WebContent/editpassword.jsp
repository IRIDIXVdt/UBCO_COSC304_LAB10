...
<form name="MyForm" method=post action="editpassword2.jsp">
    ...
    <tr>
        <td><div align="right"><font face="Arial, Helvetica, sans-serif" size="2">Your old password:</font></div></td>
        <td><input required="required" type="text" name="oldpassword" size=30 maxlength="10"></td>
    </tr>
    <tr>
        <td><div align="right"><font face="Arial, Helvetica, sans-serif" size="2">Your new password:</font></div></td>
