...
<head>
	...
	<body  background="img/bk2.jpg;" style="background-repeat:no-repeat;background-size:cover;background-attachment:fixed;"></body>
		<h1 align="center"><font face="cursive" color="#ffffff"> Thank you for your shopping! Have a nice day!</font></h1>
		<h2 align="center"><a href="index.jsp" style="color: #ffffff;">Return to the main page</a></h2>
	<style>
		h1,h2{
